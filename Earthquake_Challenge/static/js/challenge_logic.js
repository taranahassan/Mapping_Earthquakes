...
// D3 - creating a third tile layer that will be the background of the map.
...
let baseMaps = {
  ...
  // D3 - adding dark map to base layer.
  "Dark Mode": dark
};
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(data) {
    ...
    // creating tectonic plate style
    let tectonicStyle = {
      color: "darkblue",
      weight: 2
    };

    // creating GeoJSON layer with tectonic plate data.
    L.geoJson(data, tectonicStyle).addTo(tectonicPlate);
